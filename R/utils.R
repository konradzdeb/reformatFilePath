...
# https://github.com/rstudio/addinexamples and is part of
# addinexamples - nn R package showcasing how RStudio addins can be registered and used.
# more information is available on: http://rstudio.github.io/rstudioaddins/
# The addinexamples is license to RStudio, Inc.under MIT License
